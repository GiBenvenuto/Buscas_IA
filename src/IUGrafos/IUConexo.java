 ...
 * @author Gi Benvenuto
 */
public class IUConexo extends javax.swing.JFrame {
    int num;
    /**
     * Creates new form IUConexo
     */
    public IUConexo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        result.setText("____________________________");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (m != null){
            ...
            if (aux != Integer.MAX_VALUE) result.setText("O grafo é conexo");
            else result.setText("O grafo não é conexo!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUConexo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
